...
#ifndef __STM32F37X_DAC_H
#define __STM32F37X_DAC_H
...
#define DAC_Trigger_None                   ((uint32_t)0x00000000) /*!< Conversion is automatic once the DACx_DHRxxxx register 
...
#define DAC_Trigger_T5_TRGO                ((uint32_t)0x0000001C) /*!< TIM9 TRGO selected as external conversion trigger for DAC1 channel1/2 */
#define DAC_Trigger_T18_TRGO               ((uint32_t)0x0000001C) /*!< TIM18 TRGO selected as external conversion trigger for DAC2 channel1 */
#define DAC_Trigger_T2_TRGO                ((uint32_t)0x00000024) /*!< TIM2 TRGO selected as external conversion trigger for DAC1/2 channel1/2 */
#define DAC_Trigger_T4_TRGO                ((uint32_t)0x0000002C) /*!< TIM4 TRGO selected as external conversion trigger for DAC1/2 channel1/2 */
