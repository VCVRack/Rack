...
struct GtxWidget_VCO_F1 : ModuleWidget
{
	GtxWidget_VCO_F1(VCOBank *module) : ModuleWidget(module)
	{
		GTX__WIDGET();
...
struct GtxWidget_VCO_F2 : ModuleWidget
{
	GtxWidget_VCO_F2(VCO2Bank *module) : ModuleWidget(module)
	{
		GTX__WIDGET();
...
RACK_PLUGIN_MODEL_INIT(Gratrix, VCO_F1) {
   Model *model = Model::create<VCOBank, GtxWidget_VCO_F1>("Gratrix", "VCO-F1", "VCO-F1", OSCILLATOR_TAG);
   return model;
}

RACK_PLUGIN_MODEL_INIT(Gratrix, VCO_F2) {
   Model *model = Model::create<VCO2Bank, GtxWidget_VCO_F2>("Gratrix", "VCO-F2", "VCO-F2", OSCILLATOR_TAG);
   return model;
}
