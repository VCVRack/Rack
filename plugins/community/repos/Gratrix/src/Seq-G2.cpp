...
struct GtxModule_Seq_G2 : Module {
	enum ParamIds {
		CLOCK_PARAM,
		RUN_PARAM,
		RESET_PARAM,
...
struct Display : TransparentWidget
{
	...
	Display(GtxModule_Seq_G2 *module_, const Rect &box_)
	:
		module(module_)
	{
		box  = box_;
...
struct GtxWidget_Seq_G2 : ModuleWidget
{
	GtxWidget_Seq_G2(GtxModule_Seq_G2 *module) : ModuleWidget(module)
	{
		GTX__WIDGET();
		...
		addParam(createParamGTX<KnobFreeSml>                       (Vec(portX[0], portY[0]), module, GtxModule_Seq_G2::CLOCK_PARAM, -2.0f, 6.0f, 2.0f));
		addParam(ParamWidget::create<LEDButton>                    (but(portX[1], portY[0]), module, GtxModule_Seq_G2::RUN_PARAM, 0.0f, 1.0f, 0.0f));
		addChild(ModuleLightWidget::create<MediumLight<GreenLight>>(l_m(portX[1], portY[0]), module, GtxModule_Seq_G2::RUNNING_LIGHT));
		addParam(ParamWidget::create<LEDButton>                    (but(portX[2], portY[0]), module, GtxModule_Seq_G2::RESET_PARAM, 0.0f, 1.0f, 0.0f));
		addChild(ModuleLightWidget::create<MediumLight<GreenLight>>(l_m(portX[2], portY[0]), module, GtxModule_Seq_G2::RESET_LIGHT));

		addParam(createParamGTX<KnobSnapSml>                       (Vec(portX[3], portY[0]), module, GtxModule_Seq_G2::PROG_PARAM, 0.0f, 11.0f, 0.0f));
		addParam(ParamWidget::create<CKSS>                         (tog(portX[4], portY[2]), module, GtxModule_Seq_G2::PLAY_PARAM, 0.0f, 1.0f, 1.0f));
		addParam(ParamWidget::create<CKSS>                         (tog(portX[5], portY[2]), module, GtxModule_Seq_G2::EDIT_PARAM, 0.0f, 1.0f, 1.0f));

		addChild(ModuleLightWidget::create<SmallLight<GreenRedLight>>(l_s(portX[4] + dX - 30, portY[1] + 5 + 1), module, GtxModule_Seq_G2::PROG_LIGHT +  0*2));  // C
		addChild(ModuleLightWidget::create<SmallLight<GreenRedLight>>(l_s(portX[4] + dX - 25, portY[1] - 5 + 1), module, GtxModule_Seq_G2::PROG_LIGHT +  1*2));  // C#
		addChild(ModuleLightWidget::create<SmallLight<GreenRedLight>>(l_s(portX[4] + dX - 20, portY[1] + 5 + 1), module, GtxModule_Seq_G2::PROG_LIGHT +  2*2));  // D
		addChild(ModuleLightWidget::create<SmallLight<GreenRedLight>>(l_s(portX[4] + dX - 15, portY[1] - 5 + 1), module, GtxModule_Seq_G2::PROG_LIGHT +  3*2));  // Eb
		addChild(ModuleLightWidget::create<SmallLight<GreenRedLight>>(l_s(portX[4] + dX - 10, portY[1] + 5 + 1), module, GtxModule_Seq_G2::PROG_LIGHT +  4*2));  // E
		addChild(ModuleLightWidget::create<SmallLight<GreenRedLight>>(l_s(portX[4] + dX     , portY[1] + 5 + 1), module, GtxModule_Seq_G2::PROG_LIGHT +  5*2));  // F
		addChild(ModuleLightWidget::create<SmallLight<GreenRedLight>>(l_s(portX[4] + dX +  5, portY[1] - 5 + 1), module, GtxModule_Seq_G2::PROG_LIGHT +  6*2));  // Fs
		addChild(ModuleLightWidget::create<SmallLight<GreenRedLight>>(l_s(portX[4] + dX + 10, portY[1] + 5 + 1), module, GtxModule_Seq_G2::PROG_LIGHT +  7*2));  // G
		addChild(ModuleLightWidget::create<SmallLight<GreenRedLight>>(l_s(portX[4] + dX + 15, portY[1] - 5 + 1), module, GtxModule_Seq_G2::PROG_LIGHT +  8*2));  // Ab
		addChild(ModuleLightWidget::create<SmallLight<GreenRedLight>>(l_s(portX[4] + dX + 20, portY[1] + 5 + 1), module, GtxModule_Seq_G2::PROG_LIGHT +  9*2));  // A
		addChild(ModuleLightWidget::create<SmallLight<GreenRedLight>>(l_s(portX[4] + dX + 25, portY[1] - 5 + 1), module, GtxModule_Seq_G2::PROG_LIGHT + 10*2));  // Bb
		addChild(ModuleLightWidget::create<SmallLight<GreenRedLight>>(l_s(portX[4] + dX + 30, portY[1] + 5 + 1), module, GtxModule_Seq_G2::PROG_LIGHT + 11*2));  // B

		addParam(ParamWidget::create<LEDButton>                    (but(portX[6], portY[0]), module, GtxModule_Seq_G2::COPY_PARAM, 0.0f, 1.0f, 0.0f));
		addChild(ModuleLightWidget::create<MediumLight<GreenLight>>(l_m(portX[6], portY[0]), module, GtxModule_Seq_G2::COPY_LIGHT));
		addParam(ParamWidget::create<LEDButton>                    (but(portX[6], portY[1]), module, GtxModule_Seq_G2::PASTE_PARAM, 0.0f, 1.0f, 0.0f));
		addChild(ModuleLightWidget::create<MediumLight<GreenLight>>(l_m(portX[6], portY[1]), module, GtxModule_Seq_G2::PASTE_LIGHT));

		addParam(createParamGTX<KnobSnapSml>                       (Vec(portX[7], portY[0]), module, GtxModule_Seq_G2::STEPS_PARAM, 1.0f, NOB_COLS, NOB_COLS));

		addParam(ParamWidget::create<LEDButton>                    (but(portX[8], portY[0]), module, GtxModule_Seq_G2::CLEAR_PARAM, 0.0f, 1.0f, 0.0f));
		addChild(ModuleLightWidget::create<MediumLight<GreenLight>>(l_m(portX[8], portY[0]), module, GtxModule_Seq_G2::CLEAR_LIGHT));
		addParam(ParamWidget::create<LEDButton>                    (but(portX[8], portY[1]), module, GtxModule_Seq_G2::RANDOM_PARAM, 0.0f, 1.0f, 0.0f));
		addChild(ModuleLightWidget::create<MediumLight<GreenLight>>(l_m(portX[8], portY[1]), module, GtxModule_Seq_G2::RANDOM_LIGHT));

		addParam(createParamGTX<KnobSnapSml>                       (Vec(portX[9], portY[0]), module, GtxModule_Seq_G2::SPAN_R_PARAM, 1.0f, 8.0f, 1.0f));
		addParam(createParamGTX<KnobSnapSml>                       (Vec(portX[9], portY[1]), module, GtxModule_Seq_G2::SPAN_C_PARAM, 1.0f, 8.0f, 1.0f));

		addInput(createInputGTX<PortInMed>(Vec(portX[0], portY[1]), module, GtxModule_Seq_G2::CLOCK_INPUT));
		addInput(createInputGTX<PortInMed>(Vec(portX[1], portY[1]), module, GtxModule_Seq_G2::EXT_CLOCK_INPUT));
		addInput(createInputGTX<PortInMed>(Vec(portX[2], portY[1]), module, GtxModule_Seq_G2::RESET_INPUT));
		addInput(createInputGTX<PortInMed>(Vec(portX[3], portY[1]), module, GtxModule_Seq_G2::PROG_INPUT));
		addInput(createInputGTX<PortInMed>(Vec(portX[7], portY[1]), module, GtxModule_Seq_G2::STEPS_INPUT));

		{
			...
			for (std::size_t row = 0; row < LCD_ROWS; ++row, ++j)
			{
				if (OUT_LEFT ) addOutput(createOutputGTX<PortOutSml>(Vec(gridXl, gridY[j]), module, GtxModule_Seq_G2::lcd_val_map(row, 0)));
				if (OUT_RIGHT) addOutput(createOutputGTX<PortOutSml>(Vec(gridXr, gridY[j]), module, GtxModule_Seq_G2::lcd_val_map(row, 1)));
			}
			#endif
			...
			for (std::size_t row = 0; row < NOB_ROWS; ++row, ++j)
			{
				if (OUT_LEFT ) addOutput(createOutputGTX<PortOutSml>(Vec(gridXl, gridY[j]), module, GtxModule_Seq_G2::nob_val_map(row, 0)));
				if (OUT_RIGHT) addOutput(createOutputGTX<PortOutSml>(Vec(gridXr, gridY[j]), module, GtxModule_Seq_G2::nob_val_map(row, 1)));
			}
			#endif
			...
			for (std::size_t row = 0; row < BUT_ROWS; ++row, ++j)
			{
				if (OUT_LEFT ) addOutput(createOutputGTX<PortOutSml>(Vec(gridXl, gridY[j]), module, GtxModule_Seq_G2::but_val_map(row, 0)));
				if (OUT_RIGHT) addOutput(createOutputGTX<PortOutSml>(Vec(gridXr, gridY[j]), module, GtxModule_Seq_G2::but_val_map(row, 1)));
			}
			#endif
		}

		{
			...
			#if PRG_ROWS
			{
				addParam(createParamGTX<KnobSnapSml>(Vec(g_lcdX[ 4], gridY[j]), module, GtxModule_Seq_G2::PRG_ROW_PARAM,    0.0f, LCD_ROWS - 1, 0.0f));
				addParam(createParamGTX<KnobSnapSml>(Vec(g_lcdX[ 5], gridY[j]), module, GtxModule_Seq_G2::PRG_COL_PARAM,    0.0f, LCD_COLS - 1, 0.0f));
				addParam(createParamGTX<KnobSnapSml>(Vec(g_lcdX[ 6], gridY[j]), module, GtxModule_Seq_G2::PRG_SPAN_PARAM,   1.0f, LCD_COLS    , 1.0f));
				addParam(createParamGTX<KnobSnapSml>(Vec(g_lcdX[ 7], gridY[j]), module, GtxModule_Seq_G2::PRG_STRIDE_PARAM, 1.0f, LCD_COLS - 1, 1.0f));
				addParam(createParamGTX<KnobSnapSml>(Vec(g_lcdX[ 8], gridY[j]), module, GtxModule_Seq_G2::PRG_NOTE_PARAM,   0.0f,        11.0f, 0.0f));
				addParam(createParamGTX<KnobSnapSml>(Vec(g_lcdX[ 9], gridY[j]), module, GtxModule_Seq_G2::PRG_OCTAVE_PARAM, 0.0f,         8.0f, 4.0f));
				addParam(createParamGTX<KnobFreeSml>(Vec(g_lcdX[10], gridY[j]), module, GtxModule_Seq_G2::PRG_VALUE_PARAM,  0.0f,        10.0f, 0.0f));
				addParam(createParamGTX<KnobSnapSml>(Vec(g_lcdX[11], gridY[j]), module, GtxModule_Seq_G2::PRG_GATE_PARAM,   0.0f,         3.0f, 0.0f));
				++j;
			}
			#endif
			...
			for (std::size_t row = 0; row < NOB_ROWS; ++row, ++j)
			{
				...
				{
					if (GtxModule_Seq_G2::is_nob_snap(row))
					{
						addParam(createParamGTX<KnobSnapSml>(Vec(g_nobX[col], gridY[j]), module, GtxModule_Seq_G2::nob_map(row, col), 0.0f, 12.0f, 0.0f));
					}
					else
					{
						addParam(createParamGTX<KnobFreeSml>(Vec(g_nobX[col], gridY[j]), module, GtxModule_Seq_G2::nob_map(row, col), 0.0f, 10.0f, 0.0f));
					}
				}
			}
			#endif
			...
			for (std::size_t row = 0; row < BUT_ROWS; ++row, ++j)
			{
				for (std::size_t col = 0; col < BUT_COLS; ++col)
				{
					addParam(ParamWidget::create<LEDButton>                           (but(g_butX[col], gridY[j]), module, GtxModule_Seq_G2::but_map(row, col), 0.0f, 1.0f, 0.0f));
					addChild(ModuleLightWidget::create<MediumLight<RedGreenBlueLight>>(l_m(g_butX[col], gridY[j]), module, GtxModule_Seq_G2::led_map(row, col, 0)));
				}
			}
			#endif
		}
		...
		{
			addInput(createInputGTX<PortInMed>(Vec(px(0, i), py(2, i)), module, GtxModule_Seq_G2::imap(GtxModule_Seq_G2::GATE_INPUT, i)));
			addInput(createInputGTX<PortInMed>(Vec(px(1, i), py(2, i)), module, GtxModule_Seq_G2::imap(GtxModule_Seq_G2::VOCT_INPUT, i)));

			addOutput(createOutputGTX<PortOutMed>(Vec(px(8, i), py(2, i)), module, GtxModule_Seq_G2::omap(GtxModule_Seq_G2::GATE_OUTPUT, i)));
			addOutput(createOutputGTX<PortOutMed>(Vec(px(7, i), py(2, i)), module, GtxModule_Seq_G2::omap(GtxModule_Seq_G2::VOCT_OUTPUT, i)));
		}

		addInput(createInputGTX<PortInMed>(Vec(gx(0), gy(2)), module, GtxModule_Seq_G2::imap(GtxModule_Seq_G2::GATE_INPUT, GTX__N)));
		addInput(createInputGTX<PortInMed>(Vec(gx(1), gy(2)), module, GtxModule_Seq_G2::imap(GtxModule_Seq_G2::VOCT_INPUT, GTX__N)));
	}
};
...
RACK_PLUGIN_MODEL_INIT(Gratrix, Seq_G2) {
   Model *model = Model::create<GtxModule_Seq_G2, GtxWidget_Seq_G2>("Gratrix", "Seq-G2-alpha1", "Seq-G2 (alpha)", SEQUENCER_TAG);
   return model;
}
