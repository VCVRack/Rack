...
RACK_PLUGIN_MODEL_DECLARE(modular80, Nosering);
RACK_PLUGIN_MODEL_DECLARE(modular80, RadioMusic);
...
RACK_PLUGIN_INIT(modular80) {
   ...
   RACK_PLUGIN_MODEL_ADD(modular80, Nosering);
   RACK_PLUGIN_MODEL_ADD(modular80, RadioMusic);
}
