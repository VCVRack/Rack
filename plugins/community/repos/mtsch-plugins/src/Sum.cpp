...
namespace rack_plugin_mtsch_plugins {
...
using namespace rack_plugin_mtsch_plugins;

RACK_PLUGIN_MODEL_INIT(mtsch_plugins, Sum) {
   Model *modelSum = Model::create<Sum, SumWidget>("mtsch", "Sum", "Sum", UTILITY_TAG);
   return modelSum;
}
