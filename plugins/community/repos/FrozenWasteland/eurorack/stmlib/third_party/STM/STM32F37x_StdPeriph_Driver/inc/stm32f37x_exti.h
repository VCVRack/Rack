...
#define EXTI_Line23      ((uint32_t)0x00800000)  /*!< Internal interrupt line 23
                                                      ...
                                                      event */
#define EXTI_Line24      ((uint32_t)0x01000000)  /*!< Internal interrupt line 24
...
#define EXTI_Line28      ((uint32_t)0x10000000)  /*!< Internal interrupt line 28
                                                      ...
                                                      event */
#define IS_EXTI_LINE(LINE) ((((LINE) & (uint32_t)0x00) == 0x00) && ((LINE) != (uint16_t)0x00))
