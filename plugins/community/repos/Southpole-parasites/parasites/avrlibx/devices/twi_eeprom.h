...
// -----------------------------------------------------------------------------
//
// Driver for I2C eeproms (AT24C64 for example).
//
...
class TwiEeprom {
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(TwiEeprom);
};

/* static */
template<typename Bus, uint16_t eeprom_size, uint8_t base_address,
         bool auto_banking, uint8_t block_size>
uint8_t TwiEeprom<Bus, eeprom_size, base_address, auto_banking, block_size>::bank_ = 0;

}  // namespace avrlibx

#endif   // AVRLIBX_DEVICES_TWI_EEPROM_H_
