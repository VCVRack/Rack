...
extern void init_plugin_arjo_modules         (rack::Plugin *p);
...
extern void init_plugin_Bark                 (rack::Plugin *p);
...
extern void init_plugin_Edge                 (rack::Plugin *p);
extern void init_plugin_EH_modules           (rack::Plugin *p);
...
extern void init_plugin_LabSeven             (rack::Plugin *p);
...
extern void init_plugin_MicMusic             (rack::Plugin *p);
...
extern void init_plugin_noobhour             (rack::Plugin *p);
...
extern void init_plugin_QuantalAudio         (rack::Plugin *p);
...
void vst2_load_static_rack_plugins(void) {
   ...
   vst2_load_static_rack_plugin("arjo_modules",         &init_plugin_arjo_modules);
   ...
   vst2_load_static_rack_plugin("noobhour",             &init_plugin_noobhour);
