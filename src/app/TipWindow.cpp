...
static std::vector<TipInfo> tipInfos = {
	...
	{"When a menu is open, " RACK_MOD_CTRL_NAME "+click a menu item to keep the menu open. This can be useful when browsing module presets or settings.", "", ""},
	// {"", "", ""},
};
